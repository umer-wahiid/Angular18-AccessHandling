...
export class AddcustomerComponent implements OnInit {
  ...
  constructor(private builder: FormBuilder, private toastr: ToastrService, private router: Router, private service: CustomerService, private act: ActivatedRoute) {
  }
    ...
    if (this.editcode != '' && this.editcode != null) {
      ...
      this.service.GetByCode(this.editcode).subscribe(item => {
        ...
        this.customerform.setValue({
          code: this.editdata.code, name: this.editdata.code, email: this.editdata.email,
